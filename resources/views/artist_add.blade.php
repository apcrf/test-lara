...
@section('title')Добавить Артиста@endsection
	...
	<form class="row" action="{{ route('artist-save') }}" method="post">
		...
		<div class="col-10">
			...
			<div class="row mt-3">
				...
				<div class="col-lg-8">
					<input type="text" class="form-control" name="artist_name" placeholder="Введите наименование">
				</div>
			</div>
			<div class="row mt-3">
				<label class="col-form-label col-lg-4 text-lg-end">Описание:</label>
				<div class="col-lg-8">
					<textarea class="form-control" name="artist_note" rows="3" placeholder="Введите описание"></textarea>
				</div>
			</div>
			<div class="row mt-3">
